    ...
    <div className="legal-page">
      ...
      <div className="legal-content">
        ...
        <div className="legal-section">
          ...
          <p>
            Контактный адрес: zudin_daniil@mail.ru.
          </p>
        </div>
        ...
        <div className="legal-section">
          ...
          <p>
            ...
            в любое время, направив запрос на адрес: zudin_daniil@mail.ru.
          </p>
        </div>
        ...
        <div className="legal-section">
          ...
          <p>
            Для реализации любого из указанных прав направьте запрос на адрес: zudin_daniil@mail.ru.
